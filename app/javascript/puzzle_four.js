function puzzle() {
  ...
  const get_class_name = document.querySelectorAll(".panel_four")
    ...
    one_of_panel.addEventListener('click', function () {
      ...
      array.forEach(function (panel_str) {
        ...
        if (count == 1) {
          ...
          } else if (front_number == 4) {
            side_front_number = "fou"
          }else {
          ...
          } else if (back_number == 4) {
            side_back_number = "fou"
          }else {
      ...
      //成功判定
      success_count = 0
      success_judgment = document.querySelectorAll(".panel_four")
